...
<div class="content-add-parcours">
    ...
    <form action="{{route('store_projet_6', $projet->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-element-2">
                              ...
                              <p class="text-description">4. Realisation par secteur investissement directe</p> 
                                <div class="form-group" style="color:black;">
                                  ...
                                  <p class="text-description">Personnes beneficiaires ou touches</p>
                                   <div class="form-group" id="autre">
                                    ...
                                    <input type="text" class="form-control" id="name" name="nbre_homme_benefit" aria-describedby="name" placeholder="">
                                  </div>
                                  
                                  <div class="form-group" id="autre">
                                    <label for="name" style="color:black;">Nombre de femmes </label>
                                    <input type="text" class="form-control" id="name" name="nbre_femme_benefit" aria-describedby="name" placeholder="">
                                  </div>
                                  
                                  <div class="form-group" id="autre">
                                    <label for="name" style="color:black;">Nombre de jeunes </label>
                                    <input type="text" class="form-control" id="name" name="nbre_jeune_benefit" aria-describedby="name" placeholder="">
                                  </div>
                                  
                                  <div class="form-group" id="autre">
                                    <label for="name" style="color:black;">Nombre de personnes handicapées </label>
                                    <input type="text" class="form-control" id="name" name="nbre_handicap_benefit" aria-describedby="name" placeholder="">
                                  </div>
