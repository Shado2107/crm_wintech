...
<div class="content-add-parcours">
    ...
    <form action="{{route('store_projet_5', $projet->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                        ...
                        <div class="card-element-2">
                            ...
                            <p class="text-description">3.4 Origines des ressources financièrs</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="number" class="form-control" id="name" name="montant_national" aria-describedby="name" placeholder="">
                                </div>
                                
                                <div class="form-group">
                                    <label for="name" style="color:black;">Montant mobilisé au niveau international<span style="color:red">*</span> : </label>
                                    <input required type="number" class="form-control" id="name" name="montant_international" aria-describedby="name" placeholder="">
                                </div>
                                
                                <div class="form-group">
                                    <label for="name" style="color:black;">Montant sur fonds propres<span style="color:red">*</span> : </label>
                                    <input required type="number" class="form-control" id="name" name="montant_fond" aria-describedby="name" placeholder="">
                                </div>
                            ...
                            <p class="text-description">Montant contribution des partenaires financiers UE et pays membres</p>    
                             ...
                             <div class="form-group">
                                    ...
                                    <input required type="number" class="form-control" id="name" name="ue_mnt_contribution" aria-describedby="name" placeholder="">
                                </div>
                                
                                <div class="form-group">
                                    <label for="name" style="color:black;">Pays membres: </label>
                                    <input required type="number" class="form-control" id="name" name="pays_membre" aria-describedby="name" placeholder="">
                                </div>
                                
                                <div class="form-group">
                                    <label for="name" style="color:black;">USAID : </label>
                                    <input required type="number" class="form-control" id="name" name="usaid" aria-describedby="name" placeholder="">
                                </div>
                                
                                 <div class="form-group">
                                    <label for="name" style="color:black;">ACDI / Canada: </label>
                                    <input required type="number" class="form-control" id="name" name="acdi_canada" aria-describedby="name" placeholder="">
                                </div>
                                
                                 <div class="form-group">
                                    <label for="name" style="color:black;">Pays arabes: </label>
                                    <input required type="number" class="form-control" id="name" name="pays_arabe" aria-describedby="name" placeholder="">
                                </div>
                                
                                <div class="form-group" id="autre_origine1">
                                    <label for="name" style="color:black;">Autres</label>
                                    <input type="text" class="form-control" id="name" name="autre_origine" aria-describedby="name" placeholder="">
                                   </div>
