...
<div class="content-add-parcours">
    ...
    <form action="{{route('update_projet_4', $projet->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                    ...
                    <div class="col-md-12">
                        <div class="card-element-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <table>
                                                  <tr>
                                                    <th>Secteur d'intervention et investissement financier</th>
                                                    <th>Options</th>
                                                  </tr>
                                                  @foreach($sec_inters as $sec_inter)
                                                  <tr>
                                                    <td>{{$sec_inter->libelle}}</td>
                                                    <td><a href="{{route('editer_secteur_projet', $sec_inter->id)}}">Modifier</a>
                                                  </tr>
                                                 @endforeach
                                                </table>
                                </div>
                                ...
                                <div class="form-group" id="autre">
                                    ...
                                    <input type="text" class="form-control" id="name" value="{{$projet->autre_intervention}}" name="autre_intervention" aria-describedby="name" placeholder="">
                                   </div>
                              ...
                              <p class="text-description">3.2 Nombre de projets implémentés</p> 
                                <div class="form-group" style="color:black;">
                                          ...
                                          @endphp
                                           <table>
                                                  <tr>
                                                    <th>Projets implémentés</th>
                                                    <th>Nombre</th>
                                                    <th>Options</th>
                                                  </tr>
                                                  @foreach($sec_implets as $sec_implet)
                                                  <tr>
                                                    <td>{{$sec_implet->libelle}}</td>
                                                    <td>{{$sec_implet->nombre}}</td>
                                                    <td><a href="{{route('editer_secteur_imple', $sec_implet->id)}}">Modifier</a>
                                                  </tr>
                                                 @endforeach
                                                </table>
                                ...
                                <div class="form-group" style="color:black;">
                                                ...
                                                <table>
                                                  <tr>
                                                    <th>Secteur investissement directe</th>
                                                    <th>Montant</th>
                                                    <th>Options</th>
                                                  </tr>
                                                  @foreach($sec_invests as $sec_invest)
                                                  <tr>
                                                    <td>{{$sec_invest->libelle}}</td>
                                                    <td>{{$sec_invest->montant}}</td>
                                                    <td><a href="{{route('editer_secteur_investi', $sec_invest->id)}}">Modifier</a>
                                                  </tr>
                                                 @endforeach
                                                </table>
                                    <!--<div class="group-select-challanges">-->
                                ...
                                <div class="form-group" id="autre_montant1">
                                    ...
                                    <input type="text" class="form-control" id="name" value="{{$projet->autre_montant}}" name="autre_montant" aria-describedby="name" placeholder="">
                                   </div>
