...
<div class="content-add-parcours">
    ...
    <form action="{{route('update_secteur_projet', $projet->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-element-2">
                            ...
                            <p class="text-description">Secteur d'intervention</p>
        
                                  @php $sect = DB::table('secteur_interventions')->where('id', $projet->secteur_id)->first(); @endphp
                                <div class="form-group">
                                      <label for="exampleFormControlTextarea1" style="color:black;">Secteur d'intervention</label>
                                        <select name="secteur_id" class="form-controll">
                                            @if($sect)
