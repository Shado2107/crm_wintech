...
<div class="content-add-parcours">
    ...
    <form action="{{route('update_secteur_realiser', $projet->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-element-2">
                            ...
                            <p class="text-description">Modifié</p>
        
                                  
                                <div class="form-group">
                                      <label for="exampleFormControlTextarea1" style="color:black;">Secteur d'intervention</label>
                                        <select name="libelle" class="form-controll">
                                            @if($projet)
                                            <option value="{{$projet->libelle}}">{{$projet->libelle}}</option>
                                            @endif
                                ...
                                <div class="form-group">
                                    <label for="name" style="color:black;">Réaliser<span style="color:red">*</span> : </label>
                                    <input required type="number" class="form-control" id="name" value="{{$projet->realiser}}" name="realiser" aria-describedby="name" placeholder="">
                                </div>
