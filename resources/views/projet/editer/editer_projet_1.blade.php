...
<div class="content-add-parcours">
    ...
    <form action="{{route('update_projet_1', $projet->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                        ...
                        <div class="card-element-2">
                            ...
                            <p class="text-description">1. Identification </p>
                                ...
                                <div class="form-group">
                                    <label for="name" style="color:black;">1.1 Nom de l'organisation : </label>
                                    <input type="text" class="form-control" id="name" value="{{$projet->libelle}}" name="libelle" aria-describedby="name" placeholder="">
                                </div>
                                ...
                                <!--</div>-->
                                  ...
                                  <div class="form-group">
                                      <label for="exampleFormControlTextarea1" style="color:black;">1.2 Statut</label>
                                        <select name="statut" value="{{$projet->statut}}" class="form-controll">
                                             <option value="{{$projet->statut}}" disabled>@if($projet->statut == 0) Association @else ONG @endif</option>
                                 ...
                                 <div class="form-group">
                                     <label for="exampleFormControlTextarea1" style="color:black;">1.3 type</label>
                                        <select name="type" value="{{$projet->type}}" class="form-controll">
                                             <option value="{{$projet->type}}" disabled>@if($projet->type == 0) National @else International @endif</option>
                              ...
                              <div class="form-group">
                                    <label for="name" style="color:black;">1.3.1 Région : </label>
                                    <input  type="text" class="form-control" id="name" name="region" value="{{$projet->region}}" aria-describedby="name" placeholder="">
                                </div>
                                
                                 <div class="form-group">
                                    <label for="name" style="color:black;">1.3.2 Département : </label>
                                    <input required type="text" class="form-control" id="name" value="{{$projet->departement}}" name="departement" aria-describedby="name" placeholder="">
                                </div>
