...
<div class="content-add-parcours">
    ...
    <form action="{{route('update_projet_3', $projet->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
           ...
           <input type="hidden" name="token" id="token" value="{{ Illuminate\Support\Str::random(155) }}" aria-describedby="name" placeholder="">
            ...
            <div class="form-one Setp">
               <div class="head-form">
                   <h2>Etape 3 ajouter un projet</h2>
                        ...
                        <div class="card-element-2">
                                 ...
                                 <p class="text-description">2.3 Nationalité du personnel dans votre organisation</p>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <input required type="number" class="form-control" id="name" value="{{$projet->nbre_expertie}}" name="nbre_expertie" aria-describedby="name" placeholder="Nombre">
                                </div>
                                
                                 <div class="form-group">
                                        <label for="name" style="color:black;">National<span style="color:red">*</span> : </label>
                                    <input required type="number" class="form-control" id="name" value="{{$projet->nbre_national}}" name="nbre_national" aria-describedby="name" placeholder="Nombre">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="number" class="form-control" id="name" value="{{$projet->nbre_temporaire}}" name="nbre_temporaire" aria-describedby="name" placeholder="">
                                </div>
                                
                                 <div class="form-group">
                                    <label for="name" style="color:black;">Nombre permenant<span style="color:red">*</span> : </label>
                                    <input required type="number" class="form-control" id="name" value="{{$projet->nbre_permenant}}" name="nbre_permenant" aria-describedby="name" placeholder="">
                                </div>
                                

                                   <div class="form-group">
                                    <label for="name" style="color:black;">Nombre Volontaire<span style="color:red">*</span> : </label>
                                    <input required type="number" class="form-control" id="name" value="{{$projet->nbre_volontaire}}" name="nbre_volontaire" aria-describedby="name" placeholder="Nombre">
                                </div>
                                
                                 <div class="form-group">
                                        <label for="name" style="color:black;">Nombre stagiare<span style="color:red">*</span> : </label>
                                    <input  type="number" class="form-control" id="name" value="{{$projet->nbre_stagiare}}" name="nbre_stagiare" aria-describedby="name" placeholder="Nombre">
                                </div>
