...
<div class="content-add-parcours">
    ...
    <form action="{{route('update_secteur_investi', $projet->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                    ...
                    <div class="col-md-12">
                        <div class="card-element-2">
                            ...
                            <p class="text-description">Modifié</p>
                                ...
                                <div class="form-group">
                                    <label for="name" style="color:black;">Montant<span style="color:red">*</span> : </label>
                                    <input required type="number" class="form-control" id="name" value="{{$projet->montant}}" name="montant" aria-describedby="name" placeholder="">
                                </div>
