...
<div class="content-add-parcours">
    ...
    <form action="{{route('update_projet_2', $projet->id)}}" method="post" class="form-horizontal" id="demo1-upload" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                        ...
                        <div class="card-element-2">
                            ...
                            <p class="text-description">2. Information du personnel</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="number" class="form-control" id="name" value="{{$projet->nbre_employer}}" name="nbre_employer" aria-describedby="name" placeholder="">
                                </div>
                               ...
                               <p class="text-description">2.2 Sexe</p>
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="number" class="form-control" id="name" value="{{$projet->nbre_homme}}" name="nbre_homme" aria-describedby="name" placeholder="">
                                </div>
                                
                                <div class="form-group">
                                    <label for="name" style="color:black;">Nombre de femmes<span style="color:red">*</span> : </label>
                                    <input required type="number" class="form-control" id="name" value="{{$projet->nbre_femme}}" name="nbre_femme" aria-describedby="name" placeholder="">
                                </div>
                                
                                <div class="form-group">
                                    <label for="name" style="color:black;">Nombre de jeunes (-35ans)<span style="color:red">*</span> : </label>
                                    <input required type="number" class="form-control" id="name" value="{{$projet->nbre_jeune}}" name="nbre_jeune" aria-describedby="name" placeholder="">
                                </div>
                                
                                 <div class="form-group">
                                    <label for="name" style="color:black;">Nombre de personnes handicapées<span style="color:red">*</span> : </label>
                                    <input required type="number" class="form-control" id="name" value="{{$projet->nbre_perso_handicap}}" name="nbre_perso_handicap" aria-describedby="name" placeholder="">
                                </div>
